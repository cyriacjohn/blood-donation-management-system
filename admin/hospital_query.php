      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 lg-12 sm-12">
            <h1 class="page-title">Hospital Queries</h1>
          </div>
        </div>
        <hr>
        <script>
          function clickme(queryId) {
                ...
                $.ajax({
                   url: 'update_hpt_query_status.php',
                   method: 'POST',
                   data: { id: queryId },
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $row['query_phone']; ?></td>
                    ...
                    <td id="btn-text">
                      <button class="btn btn-primary btn-sm btn-danger" onclick="window.location.href = 'delete_hpt_query.php?id=<?php echo $queryId; ?>';">Delete</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
